(function() {
  ...
  var Account = (function() {
     ...
     *
     * @param {object} attributes - The attributes with wich to create the ssh key. See https://developers.digitalocean.com/documentation/v2/#ssh-keys for valid attributes.
     * @param {requestCallback} [callback] - callback that handles the response
     */
