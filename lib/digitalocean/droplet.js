(function() {
  ...
  var Droplet = (function() {
    ...
    // perPage, optional
    // callback, required
    Droplet.prototype.kernels = function(id, callback) {
      var id = arguments[0],
          i,
    ...
    // perPage, optional
    // callback, required
    Droplet.prototype.snapshots = function(id, callback) {
      var id = arguments[0],
          i,
          params = 2 <= arguments.length ? slice.call(arguments, 1, i = arguments.length - 1) : (i = 0, []),
          callback = arguments[i++];
    ...
    // perPage, optional
    // callback, required
    Droplet.prototype.backups = function(id, callback) {
      var id = arguments[0],
          i,
          params = 2 <= arguments.length ? slice.call(arguments, 1, i = arguments.length - 1) : (i = 0, []),
          callback = arguments[i++];
    ...
    // perPage, optional
    // callback, required
    Droplet.prototype.neighbors = function(id, callback) {
      var id = arguments[0],
          i,
          params = 2 <= arguments.length ? slice.call(arguments, 1, i = arguments.length - 1) : (i = 0, []),
          callback = arguments[i++];
